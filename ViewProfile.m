...
{
    [super viewDidLoad];
    [profile setImage:[UIImage imageNamed:@"icon.png"] forState:UIControlStateNormal];
...
- (IBAction)msg:(id)sender {
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Hi this is Jeet Shah" message:nil delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
